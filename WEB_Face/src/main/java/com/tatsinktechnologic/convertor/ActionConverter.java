...
public class ActionConverter implements Converter{
    ...
    public String getAsString(FacesContext context, UIComponent component, Object object) {
            ...
            if (object instanceof Action) {
                ...
                result  = action.getAction_name();
            } 
            return result;
    }

    @Override
    public Action getAsObject(FacesContext context, UIComponent component, String uuid) {
        Action action = commun_controller.getOneByAction(uuid);
        return action;
    }
}