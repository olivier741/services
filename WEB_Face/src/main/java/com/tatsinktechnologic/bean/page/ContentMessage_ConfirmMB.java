...
@Named
@ViewScoped
public class ContentMessage_ConfirmMB implements Serializable {
    ...
    public void enableEdit() {
        ...
        if (selectedContentMessage_cache.getMessage_status() == Message_Status.CONFIRM || selectedContentMessage_cache.getMessage_status() == Message_Status.SUBMIT) {
            do_enable = false;
            do_view = false;
            do_edit = true;
            do_reset = true;
            ...
            msg = new FacesMessage("This Message is not Editable you Must set it Status to SUMBIT ", null);
        ...
        if (selectedContentMessage != null) {
            ...
            try {
                ...
                if (selectedContentMessage_cache != null) {
                    if (selectedContentMessage_cache.getMessage_status() == Message_Status.SUBMIT) {
                        if (selectedContentMessage.getMessage_status() == Message_Status.CONFIRM) {
                            selectedContentMessage.setConfirm_time(confirm_time_t);
                        }
                    }
                } else {
                    if (selectedContentMessage.getMessage_status() == Message_Status.CONFIRM) {
    ...
    public String delete() {
        FacesMessage msg = null;
        if (selectedContentMessage.getMessage_status() == Message_Status.CONFIRM || selectedContentMessage.getMessage_status() == Message_Status.SUBMIT) {
            String content_label = selectedContentMessage.getContent_label().trim();
