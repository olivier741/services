...
public class InitAppMB implements Serializable {
    ...
    @PostConstruct
    public void init() {
        commun_repo.LoadUserByUsername();
        commun_repo.loadRolesPermByUsername();
        ...
        try {
            ...
            User tempUser = commun_repo.getSET_USER_USERNAME().get("admin");
            ...
            if (tempUserRoleRel == null) {
                ...
                tempUser = commun_repo.getSET_USER_USERNAME().get("admin");
