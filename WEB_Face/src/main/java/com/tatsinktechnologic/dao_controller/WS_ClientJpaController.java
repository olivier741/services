...
public class WS_ClientJpaController implements Serializable {
    ...
    public void create(WS_Client WS_Client) throws RollbackFailureException, Exception {
    ...
    public void edit(WS_Client WS_Client) throws NonexistentEntityException, RollbackFailureException, Exception {
        EntityManager em = null;
        try {
            utx.begin();
            em = getEntityManager();
