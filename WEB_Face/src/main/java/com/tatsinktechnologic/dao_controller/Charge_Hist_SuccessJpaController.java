...
public class Charge_Hist_SuccessJpaController implements Serializable {
    ...
    public Charge_Hist_SuccessJpaController(UserTransaction utx, EntityManagerFactory emf) {
        this.utx = utx;
        this.emf = emf;
    }
    ...
    public void create(Charge_Hist_Success charge_Hist_Success) throws RollbackFailureException, Exception {
    ...
    public void edit(Charge_Hist_Success charge_Hist_Success) throws NonexistentEntityException, RollbackFailureException, Exception {
        EntityManager em = null;
        try {
            utx.begin();
            em = getEntityManager();
