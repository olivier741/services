...
public class Mo_HistJpaController implements Serializable {
    ...
    public Mo_HistJpaController(UserTransaction utx, EntityManagerFactory emf) {
        this.utx = utx;
        this.emf = emf;
    }
    ...
    public void create(Mo_Hist mo_Hist) throws RollbackFailureException, Exception {
    ...
    public void edit(Mo_Hist mo_Hist) throws NonexistentEntityException, RollbackFailureException, Exception {
        EntityManager em = null;
        try {
            utx.begin();
            em = getEntityManager();
