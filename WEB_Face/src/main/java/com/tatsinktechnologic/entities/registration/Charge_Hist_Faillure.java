 ...
 */
@Entity
public class Charge_Hist_Faillure implements Serializable {
     private static final long serialVersionUID = 1L;
    
    @Transient
    private Logger logger = Logger.getLogger(Charge_Hist_Faillure.class);
    ...
    public int hashCode() {
        int hash = 7;
        hash = 67 * hash + Objects.hashCode(this.charge_his_id);
        hash = 67 * hash + Objects.hashCode(this.transaction_id);
        hash = 67 * hash + Objects.hashCode(this.msisdn);
        hash = 67 * hash + Objects.hashCode(this.charge_mode);
        hash = 67 * hash + Objects.hashCode(this.charge_time);
        hash = 67 * hash + (int) (this.charge_fee ^ (this.charge_fee >>> 32));
        hash = 67 * hash + Objects.hashCode(this.charge_request);
        hash = 67 * hash + Objects.hashCode(this.charge_response);
        hash = 67 * hash + (int) (this.duration ^ (this.duration >>> 32));
        hash = 67 * hash + Objects.hashCode(this.charge_error);
        hash = 67 * hash + Objects.hashCode(this.product);
        hash = 67 * hash + Objects.hashCode(this.process_unit);
        hash = 67 * hash + Objects.hashCode(this.IP_unit);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final Charge_Hist_Faillure other = (Charge_Hist_Faillure) obj;
    ...
    public String toString() {
        return "Charge_Hist_Faillure{" + "charge_his_id=" + charge_his_id + ", transaction_id=" + transaction_id + ", msisdn=" + msisdn + ", charge_mode=" + charge_mode + ", charge_time=" + charge_time + ", charge_fee=" + charge_fee + ", charge_request=" + charge_request + ", charge_response=" + charge_response + ", duration=" + duration + ", charge_error=" + charge_error + ", product=" + product + ", process_unit=" + process_unit + ", IP_unit=" + IP_unit + '}';
    }
