...
public class Submit_LongSMS {
	...
	public List<String> sendSMS(SMPPSession session,String user,String sourceMsisdn, String destinationMsisdn,String messageBody) throws IOException, InterruptedException {
		...
		session.setMessageReceiverListener(new Receive(user));
