...
public class ContentMessage implements Serializable {
    ...
    private Set<ServiceHistory> listServiceHistory = new HashSet<>();
    ...
    public Set<ServiceHistory> getListServiceHistory() {
        return listServiceHistory;
    }

    public void setListServiceHistory(Set<ServiceHistory> listServiceHistory) {
    ...
    public int hashCode() {
        int hash = 5;
        hash = 67 * hash + this.content_id;
        hash = 67 * hash + Objects.hashCode(this.content_label);
        hash = 67 * hash + Objects.hashCode(this.message);
        hash = 67 * hash + Objects.hashCode(this.message_status);
        hash = 67 * hash + Objects.hashCode(this.submit_time);
        hash = 67 * hash + Objects.hashCode(this.confirm_time);
        hash = 67 * hash + Objects.hashCode(this.accpt_time);
        hash = 67 * hash + Objects.hashCode(this.launch_time);
    ...
    public String toString() {
        return "ContentMessage{" + "content_id=" + content_id + ", content_label=" + content_label + ", message=" + message + ", message_status=" + message_status + ", submit_time=" + submit_time + ", confirm_time=" + confirm_time + ", accpt_time=" + accpt_time + ", launch_time=" + launch_time + ", expire_time=" + expire_time + ", create_time=" + create_time + '}';
    }
