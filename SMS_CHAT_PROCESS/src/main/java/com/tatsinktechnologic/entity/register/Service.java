...
public class Service implements Serializable {
    ...
    @OneToMany(mappedBy = "service")
    private Set<Alias> listAlias = new HashSet<>();

    @OneToMany(mappedBy = "service")
    private Set<ContentMessage> listContentMessage = new HashSet<>();
    ...
    public Set<Alias> getListAlias() {
        return listAlias;
    }

    public void setListAlias(Set<Alias> listAlias) {
        this.listAlias = listAlias;
    }

    public Set<ContentMessage> getListContentMessage() {
        return listContentMessage;
    }

    public void setListContentMessage(Set<ContentMessage> listContentMessage) {
