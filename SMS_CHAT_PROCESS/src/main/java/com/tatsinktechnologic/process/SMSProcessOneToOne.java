 ...
 */
public class SMSProcessOneToOne implements Runnable {

    private static Logger logger = Logger.getLogger(SMSProcessOneToOne.class);
    ...
    public SMSProcessOneToOne(BlockingQueue<Process_Request> reg_queue, Chat_Process chatProc, EntityManagerFactory emf) {
        this.emf = emf;
