 ...
 */
public class SMSProcessManyToMany implements Runnable {

    private static Logger logger = Logger.getLogger(SMSProcessManyToMany.class);
    ...
    public SMSProcessManyToMany(BlockingQueue<Process_Request> reg_queue, Chat_Process chatProc, EntityManagerFactory emf) {
        this.emf = emf;
            ...
            while (true) {
                ...
                if (process_mo != null) {
                    ...
                    if (chat_group != null) {
                        ...
                        ChatGroup_Register chatGrp_reg_requester = communRepo.getChatGroup_RegisterByMsisdn(receiver, msisdn);

                        if (chatGrp_reg_requester != null) {
                            ...
                            if (listChatGrp_Reg != null && !listChatGrp_Reg.isEmpty()) {
                                for (ChatGroup_Register chatGrp_reg : listChatGrp_Reg) {
                                    ...
                                    if (!chat_partener_msisdn.equals(msisdn)) {
                                        ...
                                        logger.info("Message trans_id = " + process_mo.getTransaction_id() + " --> from : " + msisdn + " to -->  " + chat_partener_msisdn + " in group : " + receiver);
                                    }
                                }
                            } else {
                            ...
                            logger.info("Message trans_id = " + process_mo.getTransaction_id() + " --> from : " + msisdn + " Not belong to Group : " + receiver);
                        }
