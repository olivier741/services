...
public class Sender implements Runnable {
    ...
    public Sender(EntityManagerFactory emf, BlockingQueue<Process_Request> send_queue, int id, int numberRecord, String topic, int sleep_duration) {
        ...
        this.product_props = (Properties)SerializationUtils.clone(commonConfig.getProducerProps()) ;
    ...
    public void run() {
        ...
        while (true) {
            ...
            if (process_mo != null) {
                ...
                String nofif_code = process_mo.getNotification_code();
                ...
                if (!StringUtils.isBlank(nofif_code)) {
                    ...
                    if (notif_conf != null) {
                        message = notif_conf.getNotification_value();
