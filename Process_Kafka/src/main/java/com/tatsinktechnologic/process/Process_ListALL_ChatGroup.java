 ...
 */
public class Process_ListALL_ChatGroup implements Runnable{
    private static Logger logger = Logger.getLogger(Process_ListALL_ChatGroup.class);
    ...
    public Process_ListALL_ChatGroup(EntityManagerFactory emf,BlockingQueue<Process_Request> account_queue,int sleep_duration) {
