 ...
 */
public class Process_ListREG_ChatGroup implements Runnable {
    private static Logger logger = Logger.getLogger(Process_ListREG_ChatGroup.class);
    ...
    public Process_ListREG_ChatGroup(EntityManagerFactory emf,BlockingQueue<Process_Request> account_queue,int sleep_duration) {
