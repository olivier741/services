...
public class Process_Guide implements Runnable{
    private static Logger logger = Logger.getLogger(Process_Guide.class);
    ...
    public Process_Guide(EntityManagerFactory emf,BlockingQueue<Process_Request> guide_queue,int sleep_duration) {
        this.emf = emf;
        this.guide_queue=guide_queue;
    ...
    public void run() {
        ...
        while (true){
           ...
           if (process_mo != null){
               ...
               switch(useproduct){
                    case 0:
                        process_mo.setNotification_code("GUIDE-PRODUCT-SUCCESS-"+product_code);
                        mo_his_desc="SUCCESS GUIDE PRODUCT";
                        
                        break;
                    case 1:
                        process_mo.setNotification_code("GUIDE-PRODUCT-WRONG-TIME-"+product_code);
                        mo_his_desc="WRONG TIME CONFIGURATION OF THIS PRODUCT";
                        break;
                    case 2:
                        process_mo.setNotification_code("GUIDE-PRODUCT-NOT-AVAILABLE-"+product_code);
                        mo_his_desc="PRODUCT IS NOT AVAILABLE";
                        break;
                    case 3:
                        process_mo.setNotification_code("GUIDE-PRODUCT-EXPIRE-"+product_code);
                    ...
                    process_mo.setNotification_code("GUIDE-PRODUCT-NOT-EXIST");
               ...
               mo_hist.setProcess_unit("Process_Guide");
