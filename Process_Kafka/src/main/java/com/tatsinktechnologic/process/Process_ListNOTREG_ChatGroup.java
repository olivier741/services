 ...
 */
public class Process_ListNOTREG_ChatGroup implements Runnable {
    private static Logger logger = Logger.getLogger(Process_ListNOTREG_ChatGroup.class);
    ...
    public Process_ListNOTREG_ChatGroup(EntityManagerFactory emf,BlockingQueue<Process_Request> account_queue,int sleep_duration) {
