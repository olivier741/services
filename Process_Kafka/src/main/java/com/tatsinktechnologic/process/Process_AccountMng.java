 ...
 */
public class Process_AccountMng implements Runnable{
     private static Logger logger = Logger.getLogger(Process_AccountMng.class);
    ...
    public Process_AccountMng(EntityManagerFactory emf,BlockingQueue<Process_Request> account_queue,int sleep_duration) {
