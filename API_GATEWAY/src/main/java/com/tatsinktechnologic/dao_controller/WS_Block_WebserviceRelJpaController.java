...
public class WS_Block_WebserviceRelJpaController implements Serializable {
    ...
    public WS_Block_WebserviceRelJpaController(EntityManagerFactory emf) {
        this.emf = emf;
    }
    ...
    public void create(WS_Block_WebserviceRel WS_Block_WebserviceRel) {
    ...
    public void edit(WS_Block_WebserviceRel WS_Block_WebserviceRel) throws NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
