...
public class WS_AccessManagementJpaController implements Serializable {
    ...
    public WS_AccessManagementJpaController(EntityManagerFactory emf) {
        this.emf = emf;
    }
    ...
    public void create(WS_AccessManagement WS_AccessManagement) {
    ...
    public void edit(WS_AccessManagement WS_AccessManagement) throws NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
