...
public class WS_Block_APIJpaController implements Serializable {
    ...
    public WS_Block_APIJpaController(EntityManagerFactory emf) {
        this.emf = emf;
    }
    ...
    public void create(WS_Block_API WS_Block_API) {
    ...
    public void edit(WS_Block_API WS_Block_API) throws NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
