...
public class WS_WebserviceJpaController implements Serializable {
    ...
    public WS_WebserviceJpaController(EntityManagerFactory emf) {
        this.emf = emf;
    }
    ...
    public void create(WS_Webservice WS_Webservice) {
    ...
    public void edit(WS_Webservice WS_Webservice) throws NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
