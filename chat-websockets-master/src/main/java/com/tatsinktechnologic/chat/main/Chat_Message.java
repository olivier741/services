package com.tatsinktechnologic.chat.main;

import com.tatsinktechnologic.chat.websocket.endpoint.ChatEndpoint;
import com.tatsinktechnologic.chat.security.AccessTokenFilter;
import com.tatsinktechnologic.chat.security.AuthenticationServlet;
...
public class Chat_Message {
    ...
    private static final Logger LOGGER = Logger.getLogger(Chat_Message.class.getName());
    ...
    public static void startServer(int port) {
        ...
        DeploymentInfo servletBuilder = Servlets.deployment()
                .setClassLoader(Chat_Message.class.getClassLoader())
                .setContextPath("/")
                .addWelcomePage("index.html")
                .addListeners(listener(Listener.class))
                .setResourceManager(new ClassPathResourceManager(Chat_Message.class.getClassLoader()))
                ...
                .setDeploymentName("Chat_Message.war");
