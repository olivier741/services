...
import com.tatsinktechnologic.ussd_gateway.mmserver.authenticator.ActionLogDbUtils;
import com.tatsinktechnologic.ussd_gateway.mmserver.authenticator.MmUser;
...
//        mmUser = MmAuthenticator.getInstance().validate(username, password, MmJMXServerSec.appId);
      ...
      {
        MmJMXServerSec.log.error("Error in validate user");
