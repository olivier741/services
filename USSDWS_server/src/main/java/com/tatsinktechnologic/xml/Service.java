...
public class Service  {
    ...
    public int hashCode() {
        ...
        hash = 23 * hash + Objects.hashCode(this.mofilter);
        hash = 23 * hash + Objects.hashCode(this.mtfilter);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!Objects.equals(this.mofilter, other.mofilter)) {
            return false;
        }
        if (!Objects.equals(this.mtfilter, other.mtfilter)) {
            return false;
        }
        return true;
    }
