 ...
 */
@Root(name = "USSDGW_API")
public class Ussd_API_Conf {
    ...
    public Ussd_API_Conf(@Element(name = "fault_msg", required = false) String fault_msg,
            @Element(name = "URL", required = true) String URL,
