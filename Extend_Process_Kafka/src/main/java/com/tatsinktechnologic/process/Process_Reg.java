 ...
 * @author olivier
 */
public class Process_Reg implements Runnable{
    private static Logger logger = Logger.getLogger(Process_Reg.class);
...
//            logger.info("ADD message in the queue :"+ process_req);
    ...
    public Process_Reg(BlockingQueue<Process_Request> reg_queue) {
