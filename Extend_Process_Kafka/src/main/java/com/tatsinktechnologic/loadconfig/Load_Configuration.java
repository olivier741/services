...
import com.tatsinktechnologic.dao_repository.Request_ConfJpaController;
...
public class Load_Configuration implements Serializable{
    ...
    private List<Request_Conf> ListCOMMAND_CONF;
    ...
    private Load_Configuration() {
        ...
        getProduct(emf);
        Request_ConfJpaController request_conf_control = new Request_ConfJpaController(emf);
        ListCOMMAND_CONF=  request_conf_control.findRequest_ConfEntities();
    ...
    public List<Request_Conf> getListCOMMAND_CONF() {
        return ListCOMMAND_CONF;
    }
