 ...
 */
@Root(name="sender_thread")
public class SenderThread_Conf {
   ...
   @Element(name="numberThread",required = true) 
    ...
    public String toString() {
        return "SenderThread_Conf{" + "numberThread=" + numberThread + ", threadPool=" + threadPool + ", sleep_duration=" + sleep_duration + ", maxQueue=" + maxQueue + '}';
    }
